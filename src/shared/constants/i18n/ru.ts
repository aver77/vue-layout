...
const ru = {
    ...
    main: {
        shortInformation: {
            ...
            description:
                "Я творческий и постоянно развивающийся разработчик с более чем трёхлетним опытом работы с React.js SPA и веб-ресурсами. Стремлюсь применить свой опыт в крупномасштабных проектах или проектах с открытым исходным кодом, решая неординарные задачи и принося прибыль клиентам.",
            contactBtn: "Связаться"
        },
        about: {
            title: "Обо мне",
            information:
                "Моя экспертиза охватывает множество разнообразных областей: я разрабатывал высоконагруженные продуктовые веб-приложения и стартап проекты, руководил разработкой небольшой команды, а также делал веб-приложения на заказ. Полученные мною навыки позволяют мне быстро вникать в любой проект, вносить в него ощутимый вклад и идеи.\n" +
        ...
        experience: {
            ...
            it1: {
                ...
                description:
                    ...
                    "*Мои усилия привели* к заметному увеличению производительности команды. Я разработал более 30 новых заявок, которые активно используют тысячи пользователей ежедневно, и внес значительные улучшения в уже существующие. Более того, я внес важные правки в рабочий процесс и создал подробную документацию для передачи своего опыта новым членам команды."
            },
            calendaria: {
                title: "Calendaria",
                ...
                description:
                    ...
                    "- Настройку frontend архитектуры на React.js и совместную работу с дизайн-командой, верстку и стилизацию приложения.\n" +
                    "- Анализ ТЗ и разработку бизнес-логики.\n" +
                    ...
                    "*Результат моей работы* - успешное завершение разработки в срок, обеспечение соответствия требованиям заказчика и достижение поставленных перед проектом целей. Мои усилия способствовали созданию приложения, которое активно поддерживается используется сотнями пользователей."
            },
            tecom: {
                title: "Теком",
            ...
            julius: {
                ...
                description:
                    "Подготовливал основной проект компании на React.js к выходу в продакшн. *Для этого я:*\n" +
                    "- Переработал верстку множества компонентов интерфейса, повысив дизайн и удобство использования.\n" +
                    "- Разработал множество фич и сложных компонентов, таких как таблицы и дэшборды.\n" +
                    "- Взаимодействовал с лидом проекта, обмениваясь идеями для успешной реализации различных функциональных возможностей.\n" +
                    "- Использовал язык GraphQL для получения данных с сервера, тесно сотрудничая с backend разработчиком.\n" +
                    "Таким образом, *мои усилия привели к* значительному увеличению скорости разработки проекта, улучшению его функциональности, интерфейса и повышению качества пользовательского опыта. Моя работа также подчеркивает мою способность успешно взаимодействовать в команде разработки и достигать коллективных целей."
            }
        },
        contact: {
            title: "Контакты",
