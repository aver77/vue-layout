...
const ru = {
    ...
    main: {
        shortInformation: {
            ...
            description:
                "Я творческий и постоянно развивающийся фронтенд-разработчик с более чем трехлетним опытом работы с React.js SPA и веб-ресурсами в ведущих проектах. Стремлюсь применить свой опыт в крупномасштабных проектах или проектах с открытым исходным кодом, решая неординарные задачи и принося прибыль клиентам.",
        ...
        projects: {
            ...
            insuranceApp: {
                ...
                longDesc:
                    ...
                    "На я выполнил свою роль в разработке и исходный код приложения передан сторонней команде для дальнейшей разработки."
            },
            nextPortfolio: {
