        ...
        experience: {
            ...
            it1: {
                ...
                description:
                    ...
                    )}, поставленных команде по заявкам, которые используют тысячи пользователей, и реализовал важнейший функцал в бета-проекте на React.js. Более того, я ${getBoldText(
